        ...
        <div ref={sectionRef} className="grid lg:grid-cols-2 gap-16 items-center opacity-0">
          ...
          <div className="space-y-8">
            <h2 className="section-title">
              ...
              <span className="section-title-bold font-moonwalk">CtrlLabs</span>
            </h2>
            
            <div className="space-y-6 text-lg text-light font-outfit font-light leading-relaxed">
              <p>
                <span className="font-bold font-moonwalk">CtrlLabs</span> is an Algerian digital agency founded on the principle of Control, inspired by the keyboard key that signifies command and mastery. We believe that true digital success comes from having complete oversight of your online presence. Our team of expert developers and designers is dedicated to providing innovative solutions that empower your business.
              </p>
